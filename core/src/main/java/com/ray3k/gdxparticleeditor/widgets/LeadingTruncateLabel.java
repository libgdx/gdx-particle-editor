 ...
 * This class has modified the Label class to show ellipses at the beginning of the text instead of the end.
 * @author Nathan Sweet */
public class LeadingTruncateLabel extends Widget {
    ...
    public LeadingTruncateLabel (@Null CharSequence text, Skin skin) {
        this(text, skin.get(LabelStyle.class));
    }

    public LeadingTruncateLabel (@Null CharSequence text, Skin skin, String styleName) {
     ...
     * color. */
    public LeadingTruncateLabel (@Null CharSequence text, Skin skin, String fontName, Color color) {
     ...
     * skin. */
    public LeadingTruncateLabel (@Null CharSequence text, Skin skin, String fontName, String colorName) {
        this(text, new LabelStyle(skin.getFont(fontName), skin.getColor(colorName)));
    }

    public LeadingTruncateLabel (@Null CharSequence text, LabelStyle style) {
    ...
    private void scaleAndComputePrefSize () {
        ...
        computePrefSize(LeadingTruncateLabel.prefSizeLayout);
    ...
    public void layout() {
        ...
        String formatted = leadingTruncate(font, text, ellipsis, textWidth);
    ...
    public static String leadingTruncate(BitmapFont font, CharSequence text, String truncate, float width) {
        ...
        var stringBuilder = new java.lang.StringBuilder(text);
        ...
        stringBuilder = new java.lang.StringBuilder(glyphs.size);
