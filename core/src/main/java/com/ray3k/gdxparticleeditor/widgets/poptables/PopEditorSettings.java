...
import com.ray3k.gdxparticleeditor.SkinLoader;
import com.ray3k.gdxparticleeditor.Utils;
import com.ray3k.gdxparticleeditor.Utils.UIscale;
...
import static com.ray3k.gdxparticleeditor.Utils.changeKeybind;
import static com.ray3k.gdxparticleeditor.Utils.clearKeybind;
...
public class PopEditorSettings extends PopTable {
    ...
    private void populate () {
        ...
        onChange(subButton, () -> {
            try {
                openFileExplorer(Gdx.files.external(".gdxparticleeditor/"));
            } catch (IOException e) {
