...
import com.ray3k.gdxparticleeditor.widgets.Carousel;
import com.ray3k.gdxparticleeditor.widgets.panels.*;
...
public class WizardTable extends Table {
    ...
    public WizardTable() {
        ...
        onChange(textButton, () -> Gdx.net.openURI("https://github.com/libgdx/gdx-particle-editor/releases"));
